        ...
        try:
            ...
            if box is not None:
                with cols[2]:
                    ...
                    st.image(image_with_box, caption='Image with Bounding Box', use_container_width=True)
            else:
        ...
        if box is not None:
            try:
                ...
                with cols[3]:
                    ...
                    st.image(cropped_image, caption='Cropped Meter Screen', use_container_width=True)
